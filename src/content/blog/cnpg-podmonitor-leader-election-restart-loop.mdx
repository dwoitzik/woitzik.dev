...
Two problems. Same database namespace. Discovered one after the other because fixing the first one required understanding the second. All of it running on a [BMAX Mini PC\*](https://amzn.to/4bv3yF1) with the [MikroTik RB5009\*](https://amzn.to/4w08b21) handling the network between the cluster and everything else.
