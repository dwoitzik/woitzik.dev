...
For the theory behind why deliberately injecting failure makes distributed systems more reliable, not less, [Designing Data-Intensive Applications\*](/go/4aUtkCs) is worth the read.
