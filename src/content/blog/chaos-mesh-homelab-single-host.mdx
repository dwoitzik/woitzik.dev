...
For the theory behind why deliberately injecting failure makes distributed systems more reliable, not less, [Designing Data-Intensive Applications\*](https://amzn.to/4aUtkCs) is worth the read.
