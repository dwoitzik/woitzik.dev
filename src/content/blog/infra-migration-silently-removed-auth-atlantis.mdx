...
This is the same class of failure [The Phoenix Project\*](https://amzn.to/4f4RHQf) spends a lot of pages on: the handoff between teams is where invariants quietly stop being true.
