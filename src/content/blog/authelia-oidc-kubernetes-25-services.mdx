...
Most of the debugging above happened at a shell prompt, grepping logs and testing OIDC flows with `curl`, not in a dashboard. [The Linux Command Line\*](/go/4gEAhv9) is still the book I'd hand someone who wants to get faster at that part.
