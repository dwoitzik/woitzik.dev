...
Most homelab IPv6 guides assume you have native IPv6 from your ISP: a delegated /56 prefix, clean RA on the WAN, no NAT. That describes maybe 30% of actual deployments in Germany. My setup runs on a [MikroTik RB5009\*](/go/4w08b21) behind a [FritzBox\*](/go/4f5WDEI) with CGN, exactly the 70% case.
