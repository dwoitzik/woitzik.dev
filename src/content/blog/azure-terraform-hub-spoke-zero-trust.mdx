...
date: "2026-05-03"
tags: ["Azure", "Terraform", "Networking", "Security"]
---
...
This article walks through how to build a Hub & Spoke architecture that is actually hardened for this environment - one that enforces Zero-Trust at the network layer on day one and is immunized against the policy drift loop that kills most IaC pipelines.

**[Get the base Hub & Spoke template free on GitHub 🐙](https://github.com/dwoitzik/terraform-azurerm-hub-spoke)**
...
Everything in this article - Zero-Trust NSGs, centralized DNS, DINE bypass logic - is packaged into a single, tested, ready-to-deploy module on GitHub. Free and MIT licensed.

For the underlying networking concepts (peering, DNS, NSGs) rather than just the Terraform syntax, [Netzwerke: Verstehen, Einrichten, Administrieren\*](https://amzn.to/4f3kTar) is the reference I keep coming back to.
