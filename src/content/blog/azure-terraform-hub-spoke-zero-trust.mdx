...
For the underlying networking concepts (peering, DNS, NSGs) rather than just the Terraform syntax, [Netzwerke: Verstehen, Einrichten, Administrieren\*](/go/4f3kTar) is the reference I keep coming back to.
