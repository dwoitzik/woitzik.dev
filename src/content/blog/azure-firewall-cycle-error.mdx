...
If the routing/NAT concepts here are the unfamiliar part rather than just the Terraform syntax, [Netzwerke: Verstehen, Einrichten, Administrieren\*](/go/4f3kTar) is the German-language reference I keep going back to.
