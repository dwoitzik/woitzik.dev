...
If the DNS/private-networking side of this is the unfamiliar part, [Netzwerke: Verstehen, Einrichten, Administrieren\*](/go/4f3kTar) covers the underlying concepts well.
