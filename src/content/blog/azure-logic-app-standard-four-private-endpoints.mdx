...
If DNS resolution and private-endpoint plumbing like this is the part that still feels like guesswork, [Netzwerke: Verstehen, Einrichten, Administrieren\*](/go/4f3kTar) is the reference I keep coming back to for the underlying concepts.
