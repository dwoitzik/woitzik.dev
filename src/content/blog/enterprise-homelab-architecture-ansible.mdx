...
Services that face the hostile public internet are strictly isolated in a DMZ VLAN (which we secured via [MikroTik firewall rules in a previous post](/blog/mikrotik-zero-trust-firewall-terraform/)).
```yaml
