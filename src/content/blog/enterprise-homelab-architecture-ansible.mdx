...
Services that face the hostile public internet are strictly isolated in a DMZ VLAN (which we secured via [MikroTik\*](https://amzn.to/4w08b21) [firewall rules in a previous post](/blog/mikrotik-zero-trust-firewall-terraform/)).
```yaml
