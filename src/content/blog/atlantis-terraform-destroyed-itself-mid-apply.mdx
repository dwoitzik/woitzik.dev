...
If you want the deeper case for why "the system that deploys everything must never depend on itself" isn't a Terraform-specific quirk but a systemic pattern that shows up everywhere in ops, [The Phoenix Project\*](/go/4f4RHQf) is the book that names it.
