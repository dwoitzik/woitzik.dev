...
Three-node k3s cluster running on Proxmox VMs (VLAN 20, server subnet), all on a single [BMAX Mini PC\*](https://amzn.to/4bv3yF1) with 64GB [Crucial DDR4 RAM\*](https://amzn.to/3QZejZn):
