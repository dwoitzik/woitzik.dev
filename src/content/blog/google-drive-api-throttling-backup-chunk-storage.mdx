...
For the deeper theory on why "the state looks wrong" and "the state is wrong" are different questions in any distributed system, [Designing Data-Intensive Applications\*](https://amzn.to/4aUtkCs) is the book I keep coming back to.
