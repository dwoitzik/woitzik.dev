...
DNS control is the foundation of any Zero-Trust network - on-premises or in the cloud. In Azure, the equivalent of this setup is Azure Private DNS Zones with Private Link resolvers.
