...
I assumed my homelab repo was clean. No one had ever flagged anything in review (there is no one else reviewing it), CI was green, and I generally try to use Vault and ExternalSecrets for anything sensitive. The repo covers everything from [MikroTik firewall rules](/blog/mikrotik-zero-trust-firewall-terraform) to Kubernetes manifests, all on a [BMAX Mini PC\*](https://amzn.to/4bv3yF1) and a handful of [Raspberry Pis\*](https://amzn.to/4wNS0oI).
