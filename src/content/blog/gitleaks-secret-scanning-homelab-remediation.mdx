...
I assumed my homelab repo was clean. No one had ever flagged anything in review (there is no one else reviewing it), CI was green, and I generally try to use Vault and ExternalSecrets for anything sensitive. The repo covers everything from [MikroTik\*](/go/4w08b21) [firewall rules](/blog/mikrotik-zero-trust-firewall-terraform) to Kubernetes manifests, all on a [BMAX Mini PC\*](/go/4bv3yF1) and a handful of [Raspberry Pis\*](/go/4wNS0oI).
