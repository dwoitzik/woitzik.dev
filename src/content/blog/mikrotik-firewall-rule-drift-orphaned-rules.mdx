...
I wrote an [article about building a zero-trust MikroTik firewall with Terraform](/blog/mikrotik-zero-trust-firewall-terraform) - default-deny chains, explicit allow rules, `place_before` for deterministic ordering. This runs on the [RB5009\*](https://amzn.to/4w08b21), whose hardware-offloaded switching matters once you're carrying multiple VLANs across a trunk. The Terraform code was correct. I'd run `terraform plan` regularly and it showed no drift.
