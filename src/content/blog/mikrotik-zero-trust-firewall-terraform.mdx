...
The same default-deny logic that drives the MikroTik firewall here applies at enterprise scale in Azure - just implemented through NSGs, Azure Firewall, and Private Link instead of RouterOS rules.
