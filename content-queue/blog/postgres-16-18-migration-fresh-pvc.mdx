...
When [CNPG (CloudNativePG)](/blog/cnpg-postgresql-operator-k3s/) upgraded from PG16 to PG18, the procedure required a fresh PVC, a full dump and restore, and a role discovery bug that nearly locked me out of the [Authelia](/blog/k3s-authelia-proxmox-homelab/) database.
