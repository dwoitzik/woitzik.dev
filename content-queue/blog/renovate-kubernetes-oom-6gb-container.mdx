...
[The Phoenix Project\*](/go/4f4RHQf) tells the same story from the human side of this exact failure mode - the automated system that everyone assumes is working, until someone finally checks.
